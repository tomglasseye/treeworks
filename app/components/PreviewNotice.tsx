 ...
 */
export type PreviewNoticeStatus = {ok: false; reason: 'missing' | 'rejected' | 'stale'}
...
export function PreviewNotice({status}: {status: PreviewNoticeStatus}) {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-0 z-[9999] flex justify-center p-3">
      ...
      >
        <p className="font-semibold">Live editing is off — showing published content</p>
        ...
        <p className="mt-2 text-bone/60">
          <a className="underline underline-offset-2" href="/api/preview/status" target="_blank">
            /api/preview/status
          </a>{' '}
          reports the details.
        </p>
