...
export function Header({
	...
	return (
		...
		<>
			...
			>
				<div className="u-container flex justify-between h-20 items-center gap-6">
					<Link
						to="/"
					...
					<div
						className={`flex items-center gap-3 ${barLinks.length ? "" : "ml-auto"} lg:gap-5`}
					>
						<span
